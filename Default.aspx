...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron jumbotron-fluid default-jumbotron-text" runat="server" id="jt_default_hero" style="background-image: url(/Assets/Images/hero-1.jpg); background-size: cover; height: 100%; padding-top: 0%;padding-bottom: 0%; margin-top:-20px;">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
